...
function SocialMediaModal({ isOpen, onClose, onSave, initialData, translations }) {
  ...
  const handleSkip = () => {
    onSave({ instagramUrl: '', twitterUrl: '' });
    onClose();
  };
      ...
      <div className="modal-content social-media-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="social-media-modal-body">
          <p className="social-media-description">
            {translations?.description || 'Ayuda a otros a encontrar a esta banda en sus redes sociales. Este paso es completamente opcional.'}
          </p>

          <div className="form-group">
            <label>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="social-icon instagram-icon">
          ...
          <div className="form-group">
            <label>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="social-icon twitter-icon">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
              {translations?.twitter || 'X / Twitter'}
            </label>
            <input
              type="url"
              name="twitterUrl"
