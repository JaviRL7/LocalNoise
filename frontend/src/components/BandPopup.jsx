...
function BandPopup({ band, user, onEdit, onDelete, translations }) {
  ...
  return (
    <div className="band-popup">
      ...
      {/* Enlaces con botones de acción en la misma línea */}
      <div className="popup-links">
        ...
        {band.instagramUrl && (
          <a href={band.instagramUrl} target="_blank" rel="noopener noreferrer" className="popup-link instagram-link" title="Instagram">
        ...
        {band.twitterUrl && (
          <a href={band.twitterUrl} target="_blank" rel="noopener noreferrer" className="popup-link twitter-link" title="X (Twitter)">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        {band.tiktokUrl && (
          <a href={band.tiktokUrl} target="_blank" rel="noopener noreferrer" className="popup-link tiktok-link" title="TikTok">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Edit/Delete buttons for owner - en la misma línea */}
        {isOwner && (
