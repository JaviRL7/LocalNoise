...
function SpotifySearch({ onSelectArtist, translations = {} }) {
  ...
  const t = {
    title: translations.title || 'Buscar en Spotify',
    searchByName: translations.searchByName || 'Buscar por nombre',
    pasteUrl: translations.pasteUrl || 'Pegar URL de Spotify',
    placeholder: translations.placeholder || 'Buscar banda en Spotify...',
    urlPlaceholder: translations.urlPlaceholder || 'https://open.spotify.com/artist/...',
    searchButton: translations.searchButton || 'Buscar',
    searching: translations.searching || 'Buscando...',
    noResults: translations.noResults || 'No se encontraron resultados',
    selectArtist: translations.selectArtist || 'Seleccionar',
    minCharsError: translations.minCharsError || 'Escribe al menos 2 caracteres',
    urlError: translations.urlError || 'Pega la URL de Spotify del artista'
  };
